...
class Channel {
  constructor(mixer, channelContainer, slider, muteButton, soloButton, transport, channelIndex) {
  ...
  toggleMute() {
    ...
    } else if (this.muteState === MUTE_STATE_AUTO) {
      this.muteState = MUTE_STATE_OFF;
    }
  }
...
class MixerModule extends Module {
  ...
  setupDOM() {
    ...
    channelContainers.forEach((channelContainer, index) => {
      ...
      const channel = new Channel(this, channelContainer, slider, muteButton, soloButton, this.transport, index);
  ...
  if (mute === true) {
    ...
    this.channels.forEach((channel) => {
      if (channel.channelIndex !== index && channel.muteState === MUTE_STATE_OFF) {
